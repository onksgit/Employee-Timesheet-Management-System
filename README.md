<div align="center" style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
    <div style="text-align: center; margin: 10px;">
        ...
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1Bi6jExFPVg6wOqHW87ekb3fSSYe8SeHC" alt="Image 1" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
    <div style="text-align: center; margin: 10px;">
        <h3>VIEW profile</h3>
    ...
    <div style="text-align: center; margin: 10px;">
        ...
        <h3>HR DASHBORD 2</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1PZ7F1sRT9bGAVwHwFE9uVz3F-a20HrZx" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
        <div style="text-align: center; margin: 10px;">
        <h3>MANAGER DASHBORD 1</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1QfTgKm7bd5ExP4U3obkOLtCH8gcnTgMV" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
        <div style="text-align: center; margin: 10px;">
        <h3>MANAGER DASHBORD 2</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1qoe4ubWKa7lP5ABisqXx2xXa_RtiIs2V" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
        <div style="text-align: center; margin: 10px;">
        <h3>EMPLOYEE DASHBORD 1</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1w_rP-TGk9U2myxc9ez2x5fnJAqTfnGbY" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
        <div style="text-align: center; margin: 10px;">
        <h3>EMPLOYEE DASHBORD 2</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1vIc0jpqUXXCHgnMc5WCA76MExYa_9ZYO" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
        <div style="text-align: center; margin: 10px;">
        <h3>ADD TIMESHEET 1</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1ceAMLSUgSghfNtIl_Dn4GhfpW2arMo01" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
            <div style="text-align: center; margin: 10px;">
        <h3>ADD TIMESHEET 2</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1sXY514NEhSKuRZvTZXvE-t-AYbr6jCaY" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
            <div style="text-align: center; margin: 10px;">
        <h3>ADD EMPLOYEE 1</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1aI_v2I-zR7miys80cAChsGMwKY8qzjaZ" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
            <div style="text-align: center; margin: 10px;">
        ...
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1552nVU4nkL39TM-hoelqEyeZChpqPi0C" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
            <div style="text-align: center; margin: 10px;">
        <h3>UPDATE EMPLOYEE 2</h3>
        <a href="#" target="_blank">
    ...
    <div style="text-align: center; margin: 10px;">
        ...
        <h3>REPORTS</h3>
        <a href="#" target="_blank">
            <img src="https://drive.google.com/uc?export=view&id=1Vk8YKwTYICchHotRuIRsUrLU2Q0IW6S1" alt="Image 2" style="max-width: 100%; height: auto;" width="280" />
        </a>
    </div>
</div>
