...
<div class="row">
	...
	<div class="col-lg-10">
		<div class="col-lg-12" align="left">
			<h3 align="center" class="title">Update Branch</h3>
		</div>
	</div>
...
<div class="well well-lg col-lg-6">
	<form:form name="updateBranch" method="POST" class="form-horizontal"
		modelAttribute="branchMaster" role="form"
		action="UpdateBranchToDB.html"
	  ...
	  <form:hidden path="primaryId" value=""/>
		...
		<div class="form-group" align="center">
			...
			<a href="ViewBranches.html"> <button class="btn bg-black" type="button" onclick="goBack()">Back</button></a>
		</div>
	</form:form>
</div>
<div class="col-lg-2"></div>
